...
def readDetails(contract_type):
    ...
    deployed_contract_address = '0x6849ad3D9076e10194fF0A0Af9D5f3F336F637F3' #hash address to access student contract
...
def saveDataBlockChain(currentData, contract_type):
    ...
    deployed_contract_address = '0x6849ad3D9076e10194fF0A0Af9D5f3F336F637F3' #contract address
    with open(compiled_contract_path) as file:
        contract_json = json.load(file)  # load contract info as JSON
        contract_abi = contract_json['abi']  # fetch contract's abi - necessary to call its functions
    file.close()
    ...
    if request.method == 'GET':
        ...
        for i in range(len(access_certificate)-1):
            ...
            if status == True:
                ...
                if os.path.exists('C:/Users/Ashruth Reddy/Desktop/expt/StudentCredentialBlockchain/StudentCredentialApp/static/certificates/'+array[4]):
                    os.remove('C:/Users/Ashruth Reddy/Desktop/expt/StudentCredentialBlockchain/StudentCredentialApp/static/certificates/'+array[4])
                with open('C:/Users/Ashruth Reddy/Desktop/expt/StudentCredentialBlockchain/StudentCredentialApp/static/certificates/'+array[4], "wb+") as file:
                    file.write(content)
                file.close()
